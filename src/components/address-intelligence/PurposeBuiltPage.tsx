...
interface PurposeBuiltPageProps {
...
export function PurposeBuiltPage({ navigate }: PurposeBuiltPageProps) {
  return (
    <div>
      {/* Hero */}
      <div className="hero">
        <div className="container">
          ...
          <HeroBadge text="Pillar 4 &middot; Competitive Clarity" />
          <h1>
            Postal Validation <span className="accent">{'\u2260'} Payment Validation</span>
          </h1>
          <p className="hero-sub">
            Generic address tools solve a fundamentally different problem. Postal validation asks "can a letter be
            delivered here?" Payment compliance asks "does this address identify a legal entity across 195 countries and
            50+ writing systems?"
          </p>
          <div className="btn-row">
            ...
            <button className="btn btn-outline">Download Position Paper</button>
          </div>
        </div>
      </div>
            ...
            <div className="feature-grid">
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Financial ID Preservation</h4>
                  <p>
                    Recognises LEI, IBAN, BIC embedded in address blocks and routes them to the correct ISO 20022
                    fields.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Geographic Disambiguation</h4>
                  <p>
                    "London" appears in six countries. "Paris" is in France and Texas. Multi-dimensional context resolves
              ...
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Multi-Script Normalisation</h4>
                  <p>
                    Native parsing for Latin, Cyrillic, Arabic, CJK, Devanagari, Thai, Hebrew&mdash;across 50+ writing
                    systems.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Entity-Level De-Duplication</h4>
                  <p>
                    Identifies when different address representations refer to the same legal entity&mdash;not just the
              ...
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Deterministic Audit Trails</h4>
                  <p>
                    Complete resolution provenance: input, parsing decisions, disambiguation logic, confidence
                    scoring&mdash;immutable records.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-text">
                  ...
                  <p>
                    Sub-100ms resolution, consistent results for identical inputs, graceful degradation under peak load.
                  </p>
                </div>
              </div>
            </div>
        ...
        <ScrollReveal>
          <div className="section">
            ...
            <div className="content-block" style={{ marginTop: 'var(--space-lg)' }}>
              <p>
                LLMs demonstrate impressive natural language capabilities but are{' '}
                <strong>architecturally unsuited</strong> for payment address resolution.
              </p>
            </div>
            <div className="feature-grid">
              <div className="feature-item">
                ...
                <div className="feature-text">
                  ...
                  <p>
                    May invent postal codes, select wrong cities, or fabricate building numbers. In payments, that's a
                    regulatory failure.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Non-Deterministic Output</h4>
                  <p>
                    Same input &rarr; different output across invocations. Sanctions screening results change. Audit
              ...
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Latency Incompatibility</h4>
                  <p>
                    1&ndash;5 seconds per request. Payment processing requires sub-100ms. An order-of-magnitude gap.
                  </p>
                </div>
              </div>
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h4>Missing Audit Provenance</h4>
                  <p>
                    Black-box reasoning. Cannot explain why an address was parsed a particular way. Regulators require
                    explainability.
                  </p>
                </div>
              </div>
              ...
              <table className="comp-table" style={{ marginTop: 'var(--space-lg)' }}>
                <thead>
                  <tr>
                    ...
                    <th>Postal APIs</th>
                    <th>Raw LLMs</th>
                    <th style={{ color: 'var(--teal-500)' }}>ioNova Purpose-Built</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr><td>Processing latency</td><td>200&ndash;500ms</td><td>1,000&ndash;5,000ms</td><td>Sub-100ms</td></tr>
          ...
          <div className="section">
            ...
            <div className="feature-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
              <div className="card">
                ...
                <p style={{ fontSize: '13px', color: 'var(--text-label)', lineHeight: 1.6 }}>
                  18&ndash;36 months to production. 195-country parsing rules. Maintenance exceeds build cost in
                  2&ndash;3 years. Feasible only for the largest institutions.
                </p>
              </div>
              <div className="card">
                <div
                ...
                >
                  Retrofit Postal Tools
                </div>
                <p style={{ fontSize: '13px', color: 'var(--text-label)', lineHeight: 1.6 }}>
                  Fragile integration chain. Fails where postal and payment requirements intersect&mdash;where
              ...
              <div className="card card-accent">
                ...
                <p style={{ fontSize: '13px', color: 'var(--text-label)', lineHeight: 1.6 }}>
                  10&ndash;16 weeks. ISO 20022 native. 195 countries from day one. Lowest total cost of ownership and
      ...
      <div className="container">
        <ScrollReveal>
          <div className="section">
            ...
            <FaqAccordion items={purposeFaqs} schemaOrg={true} />
          </div>
        </ScrollReveal>
      </div>
          ...
          <div className="section">
            ...
            <div className="related-grid">
              ...
              <div className="related-card" onClick={() => navigate('business')}>
                ...
                <p>The $8&ndash;12B problem and the economics of structured data.</p>
              </div>
              <div className="related-card" onClick={() => navigate('implementation')}>
                <h4>Implementation Guide &rarr;</h4>
                <p>Sidecar architecture and deployment timeline.</p>
              </div>
            </div>
          </div>
        </ScrollReveal>
