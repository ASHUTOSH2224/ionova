  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <HeroBadge text="Platform Pillar — Governance-by-Design" />
        <h1>
          Governance Isn't What We Added Last.
          <br />
          <span className="accent">It's What We Built First.</span>
        </h1>
        <p className="hero-sub">
          Every layer generates audit-grade evidence. Every decision is replayable. Every model change is versioned.
          Every autonomy level is gated by governance. This is the architectural foundation that makes everything
          else trustworthy.
        </p>
      </div>
      ...
      <ScrollReveal className="section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title">AI Without Governance Is a Liability Dressed as Innovation</h2>
          </div>
          <div className="prose">
            <p>
              Regulators are clear: if you can't explain it, you can't use it. The Federal Reserve's{' '}
              <strong>SR 11-7</strong> guidance applies to any model used in decision-making — including AI
              systems. The <strong>EU AI Act</strong> classifies entity resolution in financial services as
              high-risk AI requiring transparency, human oversight, and risk management.
            </p>
            <p>
              Most enterprise AI treats governance as an afterthought — a logging layer added post-launch, an
              audit trail assembled retrospectively from scattered logs. Governance-by-design means the platform
              produces compliance artifacts as a natural byproduct of operation. Not because someone remembered to
              turn on logging, but because the architecture makes it impossible to operate without producing an
              audit trail.
            </p>
          </div>
        </div>
      ...
      <ScrollReveal className="section">
        <div className="container">
          <div className="section-header">
            <div className="section-label">Five Capabilities</div>
            <h2 className="section-title">Make Your Auditor's Job Easy — and Yours Easier</h2>
          </div>
          <div className="g2">
            <div className="card card-accent">
              ...
              <div className="card-body">
                Every decision generates a complete pack: input data, processing steps, matching scores, rules
                fired, determination, source documents, and confidence assessment. Cryptographically timestamped
                and immutable.
              </div>
            </div>
            <div className="card card-accent">
              ...
              <div className="card-body">
                Any decision can be replayed to show exactly what happened, with what data, at what point in time.
                Deterministic reconstruction — including model version, data state, and active configuration.
              </div>
            </div>
            <div className="card card-accent">
              ...
              <div className="card-body">
                Continuous monitoring of performance, data quality, and decision patterns. When accuracy degrades
                below thresholds, the system alerts teams and can automatically dial back autonomy levels.
              </div>
            </div>
            <div className="card card-accent">
              ...
              <div className="card-body">
                Pre-assembled packages for model risk management: performance metrics, sensitivity analysis, bias
                assessment, exception tracking. Produced during normal operation, not retrofitted.
              </div>
            </div>
          </div>
          <div style={{ marginTop: 'var(--space-lg)' }}>
            <div className="card card-dark card-accent">
              ...
              <div className="card-body">
                Governance gates control the four autonomy levels. Each gate requires evidence thresholds,
                committee approval, and documented rationale. Autonomy can be dialed back at any time — for the
                entire platform, a specific workflow, or a single entity type.
              </div>
            </div>
          </div>
        </div>
      ...
      <ScrollReveal className="section">
        <div className="container">
          <div className="section-header">
            <div className="section-label">Regulatory Alignment</div>
            <h2 className="section-title">Designed for the Regulators You Have — and the Ones Coming</h2>
          </div>
          <table className="token-table">
            <thead>
              <tr>
                <th>Framework</th>
                <th>Requirement</th>
                <th style={{ background: 'rgba(95,207,208,.08)', color: 'var(--teal-500)' }}>ioNova Solution</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td><strong>SR 11-7</strong></td>
                <td>Model validation, performance monitoring</td>
                <td className="chk">MRM-ready artifacts, drift monitoring</td>
              </tr>
              <tr>
                <td><strong>EU AI Act</strong></td>
                <td>Transparency, human oversight</td>
                <td className="chk">Evidence packs, progressive autonomy</td>
              </tr>
              <tr>
                <td><strong>BSA/AML</strong></td>
                <td>Transaction monitoring, record keeping</td>
                <td className="chk">Entity audit trails, 5-year retention</td>
              </tr>
              <tr>
                <td><strong>GDPR</strong></td>
                <td>Right to explanation, data lineage</td>
                <td className="chk">Decision replayability, processing logs</td>
              </tr>
              <tr>
                <td><strong>DORA</strong></td>
                <td>ICT risk management, testing</td>
                <td className="chk">Continuous monitoring, governance controls</td>
              </tr>
              <tr>
                <td><strong>CTA</strong></td>
                <td>Beneficial ownership verification</td>
                <td className="chk">Entity resolution with ownership evidence</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="container">
          <div className="proof-bar" style={{ animation: 'none' }}>
            <div className="kpi-tile">
              <div className="kpi-value grad">80%</div>
              <div className="kpi-label">Faster audit response</div>
            </div>
            <div className="kpi-tile">
              <div className="kpi-value grad-b">100%</div>
              <div className="kpi-label">Decision traceability</div>
            </div>
            <div className="kpi-tile">
              <div className="kpi-value grad-t">SR 11-7</div>
              <div className="kpi-label">Architecture aligned</div>
            </div>
            <div className="kpi-tile">
              <div className="kpi-value grad">24/7</div>
              <div className="kpi-label">Continuous drift detection</div>
            </div>
          </div>
        </div>
      </ScrollReveal>
      ...
      <ScrollReveal className="faq-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title">Governance-by-Design — Your Questions Answered</h2>
          </div>
          <FaqAccordion items={governanceFaqs} schemaOrg={true} />
        </div>
      </ScrollReveal>
      ...
      <CtaBand
        headline={
          <>
            Governance Should Accelerate AI, <span className="text-grad">Not Slow It Down.</span>
          </>
        }
        sub="Audit-grade by architecture. Compliant by design. Ready today."
      >
        <a className="btn btn-accent btn-lg" style={{ cursor: 'pointer' }}>See Governance in Action</a>
        <a className="btn btn-outline" style={{ cursor: 'pointer' }}>Download Regulatory Guide</a>
      </CtaBand>
    </>
  );
}
