...
export default function ROICalculator() {
  ...
  return (
    <div className="ds-v5">
      <div className="narrative" style={{ marginTop: 0, marginBottom: "var(--space-lg)", textAlign: "left", maxWidth: "700px", width: "100%", marginInline: "auto" }}>
      ...
      {hasCalculated && (
        <>
          ...
          <div className="sub-label" style={{ marginTop: "var(--space-sm)", marginBottom: "var(--space-xs)", textAlign: "center" }}>Select an approach to compare</div>
      ...
      <div style={{ marginTop: "var(--space-xl)", marginBottom: "var(--space-2xl)", textAlign: "center" }}>
