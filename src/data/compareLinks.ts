export const compareFooterLinks = [
  ...
  { label: "Alpina TxFlow", href: "/compare/alpina-txflow" },
  { label: "Melissa", href: "/compare/melissa" },
  { label: "NTT Addresstune", href: "/compare/ntt-addresstune" },
  { label: "AddressHub", href: "/compare/addresshub" },
] as const;
